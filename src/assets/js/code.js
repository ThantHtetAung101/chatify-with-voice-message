...
function editMessage(id, message) {
    $.ajax({
        url: url + "/editMessage",
        method: "POST",
        data: { _token: csrfToken, id: id, message: message },
        dataType: "JSON",
        beforeSend: () => {
            // hide edit modal
            app_modal({
...
$(document).ready(function () {
    ...
    $("body").on("click", ".message-card .actions .edit-btn", function () {
        app_modal({
            name: "edit",
            data: $(this).data("id"),
    ...
    $(".app-modal[data-name=edit]")
        .find(".app-modal-footer .edit")
        .on("click", function () {
            const id = $("body")
                .find(".app-modal[data-name=edit]")
                .find(".app-modal-card")
                .attr("data-modal");
            const value = $("body")
                .find(".app-modal[data-name=edit]")
                .find("#edited-message").val();
